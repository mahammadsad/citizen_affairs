...
|---|---|---|---|
| Public runtime | Static Astro output on the existing GitHub Pages path; P0–P2 release plus verified maintenance live | Mahammad Sad | Production health served `32c952d24f2bd1314944a61eb7b50dbc40e07dce`; no runtime database required |
...
| Accessibility and browser QA | Live desktop keyboard pass complete; broader WCAG 2.2 AA and multi-browser/device review ongoing | Mahammad Sad | PR #169; run `31268142488`; manual 1363 × 936 check confirmed skip link → focused `main` → first main-content link |
