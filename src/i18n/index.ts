...
export const UI = {
  en: {
    ...
    searchPlaceholder: 'Search jobs, schemes, admit cards, results…', searchHint: 'Search source-linked public-service information.', noResults: 'No matching information found.',
    ...
    independent: 'Independent information platform', heroTitle: 'Government Jobs and Welfare Scheme Guides',
    ...
    latestTicker: 'Recent Updates', tickerEmpty: 'No updates have been published yet.', copyEmail: 'Copy email', copied: 'Copied', officialLinks: 'Official links and sources',
    ...
    featuredEmptyTitle: 'No featured update is available right now', featuredEmptyBody: 'Browse published public-service information or check back soon.',
  ...
  bn: {
    ...
    searchPlaceholder: 'চাকরি, প্রকল্প, অ্যাডমিট কার্ড, ফলাফল খুঁজুন…', searchHint: 'সূত্র-সংযুক্ত জনসেবামূলক তথ্য খুঁজুন।', noResults: 'মিলছে এমন তথ্য পাওয়া যায়নি।',
    ...
    independent: 'স্বাধীন তথ্য প্ল্যাটফর্ম', heroTitle: 'সরকারি চাকরি ও জনকল্যাণ প্রকল্পের গাইড',
    ...
    latestTicker: 'সাম্প্রতিক আপডেট', tickerEmpty: 'এখনও কোনো আপডেট প্রকাশিত হয়নি।', copyEmail: 'ইমেইল কপি করুন', copied: 'কপি হয়েছে', officialLinks: 'অফিসিয়াল লিঙ্ক ও সূত্র',
    ...
    featuredEmptyTitle: 'এই মুহূর্তে কোনো বিশেষ আপডেট নেই', featuredEmptyBody: 'প্রকাশিত জনসেবামূলক তথ্য দেখুন অথবা পরে আবার আসুন।',
  ...
  hi: {
    ...
    searchPlaceholder: 'नौकरियाँ, योजनाएँ, एडमिट कार्ड, परिणाम खोजें…', searchHint: 'स्रोतों से जुड़ी जनसेवा जानकारी खोजें।', noResults: 'कोई मिलती-जुलती जानकारी नहीं मिली।',
    ...
    independent: 'स्वतंत्र सूचना मंच', heroTitle: 'सरकारी नौकरियाँ और कल्याणकारी योजना गाइड',
    ...
    latestTicker: 'हाल के अपडेट', tickerEmpty: 'अभी तक कोई अपडेट प्रकाशित नहीं हुआ है।', copyEmail: 'ईमेल कॉपी करें', copied: 'कॉपी हो गया', officialLinks: 'आधिकारिक लिंक और स्रोत',
    ...
    featuredEmptyTitle: 'अभी कोई विशेष अपडेट उपलब्ध नहीं है', featuredEmptyBody: 'प्रकाशित जनसेवा जानकारी देखें या कुछ समय बाद फिर आएँ।',
